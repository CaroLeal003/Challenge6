    ...
    static let allLevels: [Level] = [
        ...
        Level(learn:
                ...
                RythmGame(
                    level: 2,
                    allBars: [
                        NoteBarConfig(duration: 80, color: .colorOrange, name: "Re", verticalOffset: -61),
                        NoteBarConfig(duration: 90, color: .colorBrown, name: "do", verticalOffset: -73),
                        NoteBarConfig(duration:  50, color: .colorOrange, name: "Re", verticalOffset: -61),
                        NoteBarConfig(duration:  50, color: .colorOrange, name: "Re", verticalOffset: -61),
                        NoteBarConfig(duration: 70, color: .colorBrown, name: "do", verticalOffset: -73),
        ...
        Level(learn:
                ...
                RythmGame(
                    level: 3,
                    allBars: [
                        NoteBarConfig(duration: 70, color: .colorYellow, name: "Mi", verticalOffset: -49),
                        NoteBarConfig(duration: 70, color: .colorOrange, name: "Re", verticalOffset: -61),
                        NoteBarConfig(duration: 70, color: .colorBrown, name: "do", verticalOffset: -73),
                        NoteBarConfig(duration: 70, color: .colorOrange, name: "Re", verticalOffset: -61),
        ...
        Level(learn:
                ...
                RythmGame(
                    level: 4,
                    allBars: [
                        NoteBarConfig(duration: 80, color: .colorGreen, name: "Fa", verticalOffset: -38),
                        NoteBarConfig(duration: 80, color: .colorBrown, name: "do", verticalOffset: -73),
                        NoteBarConfig(duration: 80, color: .colorGreen, name: "Fa", verticalOffset: -38),
                        NoteBarConfig(duration: 60, color: .colorBrown, name: "do", verticalOffset: -73),
                        NoteBarConfig(duration: 60, color: .colorOrange, name: "Re", verticalOffset: -61),
                        NoteBarConfig(duration: 60, color: .colorYellow, name: "Mi", verticalOffset: -49),
                        NoteBarConfig(duration: 80, color: .colorGreen, name: "Fa", verticalOffset: -38),
        ...
        Level(learn:
                ...
                RythmGame(
                    level: 5,
                    allBars: [
                        NoteBarConfig(duration: 70, color: .colorBlue, name: "Sol", verticalOffset: -25),
                        NoteBarConfig(duration: 70, color: .colorGreen, name: "Fa", verticalOffset: -38),
                        NoteBarConfig(duration: 70, color: .colorYellow, name: "Mi", verticalOffset: -49),
                        NoteBarConfig(duration: 100, color: .colorBlue, name: "Sol", verticalOffset: -25),
                        NoteBarConfig(duration: 100, color: .colorYellow, name: "Mi", verticalOffset: -49),
                        NoteBarConfig(duration: 100, color: .colorBlue, name: "Sol", verticalOffset: -25),
        ...
        Level(learn:
                ...
                RythmGame(
                    level: 6,
                    allBars: [
                        NoteBarConfig(duration: 60, color: .colorPurple, name: "La", verticalOffset: -13),
                        NoteBarConfig(duration: 60, color: .colorBlue, name: "Sol", verticalOffset: -25),
                        NoteBarConfig(duration: 60, color: .colorGreen, name: "Fa", verticalOffset: -38),
                        NoteBarConfig(duration: 60, color: .colorOrange, name: "Re", verticalOffset: -61),
                        NoteBarConfig(duration: 80, color: .colorBlue, name: "Sol", verticalOffset: -25),
                        NoteBarConfig(duration: 100, color: .colorPurple, name: "La", verticalOffset: -13),
                        NoteBarConfig(duration: 100, color: .colorPurple, name: "La", verticalOffset: -13),
        ...
        Level(learn:
              ...
              , game:
                RythmGame(
                    level: 7,
                    allBars: [
                        NoteBarConfig(duration: 60, color: .colorPink, name: "Si", verticalOffset: 0),
                        NoteBarConfig(duration: 60, color: .colorBlue, name: "Sol", verticalOffset: -25),
                        NoteBarConfig(duration: 60, color: .colorYellow, name: "Mi", verticalOffset: -49),
                        NoteBarConfig(duration: 60, color: .colorYellow, name: "Mi", verticalOffset: -49),
                        NoteBarConfig(duration: 80, color: .colorPink, name: "Si", verticalOffset: 0),
                        NoteBarConfig(duration: 80, color: .colorBlue, name: "Sol", verticalOffset: -25),
                        NoteBarConfig(duration: 100, color: .colorPink, name: "Si", verticalOffset: 0),
